...
- **Source code** is generally understood to mean programming statements that are created by a programmer with a text editor or a visual programming tool and then saved in a file. [washington.edu](https://www.washington.edu/research/glossary/source-code-and-object-code/)

## Object Code

- With the help of an adequate **compiler**, for example GCC, source code is translated into **object code**, first. 

## Binary files (ELF files)

- ELF = "Executable and Linkable Format"
- see [binary vs executable](../build/notes-build/#binary-vs-executable)
...
From cppreference ("C language" part): [Storage duration](https://en.cppreference.com/w/c/language/storage_duration#Storage_duration)
...
```c
// https://stackoverflow.com/a/8208106
// given:
int *p;
int a = 100;
p = &a;
...
- Casting a variable expression to `void` to suppress this ("`unused local variables or function parameters`") warning has become an idiom in the C and later C++ community, [stackoverflow](https://stackoverflow.com/a/34290286)
  - The Standard says in §5.2.9/4 says: "Any expression can be explicitly converted to type `cv void`. The expression value is discarded.", [stackoverflow](https://stackoverflow.com/a/34289000)
...
#### Call Stack vs Stack (Abstract Data Type)

- the "stack" discussed here is not to be confused with the [ADT](https://en.wikipedia.org/wiki/Stack_(abstract_data_type)) called "stack"
- [Stack trace](https://en.wikipedia.org/wiki/Stack_trace)
    - "Stack also refers to a programming construct, thus to differentiate it, this stack is referred to as the program's <span style="color:red">**function call stack**</span>."
        - [Stack (abstract data type)](https://en.wikipedia.org/wiki/Stack_(abstract_data_type)):
            - a <span style="color:red">**stack**</span> is an abstract data type that serves as a collection of elements with two main operations:
            ...
            - A stack can be easily <span style="color:red">**implemented**</span> either through an **array** or a **linked list**, as it is merely a special case of a list. In either case, what identifies the data structure as a stack is not the implementation but the interface: the user is only allowed to pop or push items onto the array or linked list, with few other helper operations.
            - [data structure](https://en.wikipedia.org/wiki/Data_structure) vs <span style="color:red">**abstract data type**</span>: Data structures serve as the basis for abstract data types (ADT). The ADT defines the logical form of the data type. The **data structure** <span style="color:red">**implements**</span> the physical form of the data type.
